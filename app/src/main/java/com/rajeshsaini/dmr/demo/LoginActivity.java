...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       if(MySharedPreferences.getSharedPreferences(this,Admin.USER_ID).length()>0){
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                URL url = new URL(Admin.getUserInfo());
                    ...
                    if(object.has(Admin.SUCCESS)){
                        ...
                        if(success==1){
                            if(object.has(Admin.MOBILE)){
                                MySharedPreferences.setSharedPreferences(getApplicationContext(),Admin.MOBILE,object.getString(Admin.MOBILE));
                            }
                            if(object.has(Admin.USER_ID)){
                                MySharedPreferences.setSharedPreferences(getApplicationContext(),Admin.USER_ID,object.getString(Admin.USER_ID));
                            }
                            return true;
                        }else{
                            return false;
