...
public class ParentRequest_backup extends AppCompatActivity implements View.OnClickListener {
...
/*
        ...
        */
        ...
        HashMap<String,String> params = new HashMap<String, String>();
        params.put(Admin.USER_ID, MySharedPreferences.getSharedPreferences(ParentRequest_backup.this, Admin.USER_ID));
        new RequestChild().execute(params);
    ...
    runOnUiThread(new Runnable() {
        ...
        public void run() {
            if(navItemView!=null) {
                navItemView.setAdapter(new NavItemRequestAdapter(getApplicationContext(), R.layout.drawer_menu_item_request, navItems,ParentRequest_backup.this));
            }
        }
    });
    }
   ...
   private  class NavItemRequestAdapter extends ArrayAdapter<NavItemRequest> {
        ...
        public View getView(int position, final View convertView, ViewGroup parent) {
            ...
            */
            ...
            request_confirm.setOnClickListener(ParentRequest_backup.this);
            request_reject.setOnClickListener(ParentRequest_backup.this);
